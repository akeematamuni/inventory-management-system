...
import {
    WAREHOUSE_REPOSITORY, PRODUCT_REPOSITORY, ADJUSTMENT_REPOSITORY,
    CYCLE_COUNT_REPOSITORY, PRODUCT_SETTINGS_REPOSITORY, PURCHASE_ORDER_REPOSITORY,
    STOCK_ALERT_REPOSITORY, STOCK_BALANCE_REPOSITORY, STOCK_LEDGER_ENTRY_REPOSITORY,
    STOCK_TRANSFER_REPOSITORY, INVENTORY_EVENT_PUBLISHER
} from './domain';

import {
    AdjustmentEntityTypeOrm, CycleCountLineEntityTypeOrm, CycleCountEntityTypeOrm,
    PurchaseOrderLineEntityTypeOrm, PurchaseOrderEntityTypeOrm, ProductSettingsEntityTypeOrm,
    StockAlertEntityTypeOrm, StockBalanceEntityTypeOrm, StockLedgerEntryEntityTypeOrm,
    StockTransferLineEntityTypeOrm, StockTransferEntityTypeOrm,
    WarehouseEntityMongo, WarehouseSchema, 
    ProductEntityMongo, ProductSchema,
    AdjustmentRepositoryTypeOrm, CycleCountRepositoryTypeOrm, ProductSettingsRepository,
    PurchaseOrderRepositoryTypeOrm, StockAlertRepositoryTypeOrm, StockBalanceRepositoryTypeOrm,
    StockLedgerEntryRepositoryTypeOrm, StockTransferRepositoryTypeOrm,
    WarehouseRepositoryMongo, ProductRepositoryMongo,
    InventoryPublisherEmitter, InventoryPublisherKafka,
    StockBalanceUpdateHandler, StockBalanceUpdateHandlerKafka
} from './infrastructure';
...
import {
    ...
    AdjustmentController, CycleCountController,
    OpeningStockController, PurchaseController,
